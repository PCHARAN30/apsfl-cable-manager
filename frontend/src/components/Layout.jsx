    ...
    <div className="flex flex-col md:flex-row h-[100dvh] bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 relative overflow-hidden font-sans transition-colors duration-300">
      ...
      <header className="md:hidden sticky top-0 h-[60px] bg-[#075E54] dark:bg-slate-800 z-50 flex items-center justify-between px-4 transition-colors shadow-sm">
        ...
        {isInstallable && (
          ...
          {pathname === '/customers' && (
            <button onClick={() => window.dispatchEvent(new CustomEvent('toggle-delete-mode'))} className="hover:text-red-400 transition-colors flex items-center justify-center" title="Toggle Bulk Delete">
      ...
      <div className="hidden md:flex absolute top-6 right-8 z-40 items-center gap-3 bg-white dark:bg-slate-800 px-4 py-2 rounded-xl border-2 border-slate-300 dark:border-slate-600 shadow-md">
        {pathname === '/customers' && (
          <button onClick={() => window.dispatchEvent(new CustomEvent('toggle-delete-mode'))} className="text-slate-700 dark:text-slate-300 hover:text-red-500 transition-colors flex items-center justify-center" title="Toggle Bulk Delete">
