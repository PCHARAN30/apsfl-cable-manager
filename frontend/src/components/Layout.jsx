...
const IcoReports = () => <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
const IcoInventory = () => <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
...
export default function Layout({ user, onLogout, children }) {
  ...
  const navItems = [
    ...
    { path: '/collection', label: t('collection'), icon: IcoCollection },
    { path: '/payments', label: t('payments'), icon: IcoPay },
    { path: '/reports', label: t('reports'), icon: IcoReports },
    { path: '/inventory', label: t('inventory'), icon: IcoInventory },
    { path: '/services', label: t('services'), icon: IcoServices },
  ...
  return (
    <div className="flex h-screen bg-[var(--bg-base)] text-[var(--text-base)] relative overflow-hidden font-sans transition-colors duration-300">
      ...
      <div className={`md:hidden fixed inset-0 bg-black/60 backdrop-blur-sm z-40 transition-opacity duration-300 ${sidebarOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`} onClick={() => setSidebarOpen(false)} aria-hidden="true" />
